    ...
    public function up()
    {
        ...
        DB::collection('payment_methods')
            ...
            ->update([
                ...
                'description' => "Por favor, realiza la transferencia bancaria usando el número de pedido como referencia de pago. Una vez realidada la transferencia, envia el comprobante de la transferencia al email <a href=\"mailto:hola@bikebitants.com\">hola@bikebitants.com</a>. Tu pedido no será enviado hasta que recibamos el comprobante de la transferencia.<br><br>Banc Sabadell<br>Numero de cuenta<br>00815224470001279131<br>IBAN<br>ES9700815224470001279131<br>BIC / Swift<br>BSAB ESBB"
            ]);
    }
