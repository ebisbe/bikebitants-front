...
class CheckoutController extends Controller
{
    ...
    public function store()
    {
        $this->validate($this->request, [
            ...
            'billing.phone' => 'required|digits_between:9,13',
            'billing.country' => 'required',
            'billing.state' => 'required',

            'shipping.first_name' => 'required_without:check_shipping',
            'shipping.email' => 'required_without:check_shipping|nullable|email',
            ...
            'shipping.phone' => 'required_without:check_shipping|nullable|digits_between:9,13',
