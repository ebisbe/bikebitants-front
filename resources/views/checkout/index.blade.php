                    ...
                    <article class="account-content checkout-steps">
                        ...
                        <form>
                            ...
                            <div class="products-order checkout billing-information">
                                <button class="btn btn-primary addresses-toggle" type="button" data-toggle="collapse"
                            ...
                            <div class="products-order checkout shipping-information">
                                <div class="checkbox">
                                    ...
                                    <label for="check-shipping" data-toggle="collapse"
                                           data-target="#shipping-address-collapse"
                                           aria-controls="shipping-address-collapse">My delivery and billing addresses
                                        are the same.</label>
                                </div>
