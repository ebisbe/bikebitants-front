                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>{{ $order->shipping->country->name }} ({{ $order->shipping->states()->name }})
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                ...
                                <ul class="list-unstyled">
                                    <li><b>@lang('checkout.email_address'): </b>{{ $order->shipping->email ?? $order->billing->email }}</li>
                                    <li><b>@lang('checkout.phone'): </b>{{ $order->shipping->phone ?? $order->billing->phone }}</li>
                                </ul>
                                    ...
                                    <tr>
                                        <td class="col-xs-1">
                                            <img src="/img/70/{{ $item->product->front_image->filename }}"
                                                 alt="{{ $item->product->front_image->alt }}" class="img-responsive">
                                        </td>
