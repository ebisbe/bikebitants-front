...
<div class="panel panel-flat">
    ...
    <table class="table table-bordered table-striped table-hover datatable-scroller">
        <thead>
            <tr>
                <th>Id</th><th>Name</th><th>Slug</th><th>Description</th><th>Filename</th><th>Featured</th><th>Meta Title</th><th>Meta Description</th><th>Meta Keywords</th>
            </tr>
        </thead>
    </table>
</div>
        ...
        $.extend($.fn.dataTable.defaults, {
            columns: [
                {'data': '_id'},
                {
                    ...
                    },{'data': 'slug'},{'data': 'description'},{'data': 'filename'},{'data': 'featured'},{'data': 'meta_title'},{'data': 'meta_description'},{'data': 'meta_keywords'}
            ],
            columnDefs: [
                {
                    width: "100px",
                ...
                {
                    width: "23%",
                    targets: ['name','slug','description','filename','featured','meta_title','meta_description','meta_keywords']
                }
            ],
